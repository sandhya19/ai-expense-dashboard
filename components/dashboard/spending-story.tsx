...
export function SpendingStory({ story, dna }: { story: SpendingStory; dna: SpendingDnaTrait[] }) {
  ...
  return (
    <section className="grid gap-4 xl:grid-cols-12">
      <Card className="overflow-hidden border-0 bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-900 text-white shadow-xl xl:col-span-7">
      ...
      <Card className="xl:col-span-5">
        <CardContent className="p-6">
          <div className="flex items-center gap-2"><BrainCircuit className="size-5 text-primary" /><div><h2 className="font-semibold">Your Spending DNA</h2><p className="text-sm text-muted-foreground">A profile that grows with your receipts.</p></div></div>
